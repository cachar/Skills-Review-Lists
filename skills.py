...
def smallest_int(number_list):
    ...
    if number_list == []:
        ...
        smallest_integer = number_list[0]
...
def halvesies(number_list):
    ...
    """
    half_number = [float(num) / 2 for num in number_list]
    return half_number
...
def average(number_list):
    ...
    """
    sum_of_numbers = sum_numbers(number_list)
    num_of_numbers = 0
    for num in number_list:
        num_of_numbers += 1
    return float(sum_of_numbers) / num_of_numbers
...
def join_strings_with_comma(list_of_words):
    ...
    """
    joined_strings = list_of_words[0]
